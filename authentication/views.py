...
from .serializers import SetNewPasswordSerializer,LoginSerializer, RegisterSerializers,EmailVerificationSerializer, ResetPasswordEmailRequestSerializer
...
class RequestPasswordResetEmail(generics.GenericAPIView):
    ...
    def post(self, request):
         ...
         if User.objects.filter(email=email).exists():
                ...
                relativeLink = reverse('password-reset',kwargs={
